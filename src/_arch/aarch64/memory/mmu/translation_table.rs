...
// A table descriptor, as per ARMv8-A Architecture Reference Manual
...
// A level 3 page descriptor, as per ARMv8-A Architecture Reference Manual
register_bitfields! {u64,
    STAGE1_PAGE_DESCRIPTOR [
        ...
        /// Physical address of the next table descriptor (lv12) or the page descriptor (lv13)
        ...
        /// Memory attributes index into the MAIR_EL1 reg
...
/// A page descriptor for 64 KiB aperture.
///
/// The output points to the next page.
#[derive(Copy, Clone)]
#[repr(C)]
...
pub struct FixedSizeTranslationTable<const NUM_TABLES: usize> {
    /// Page descriptors, convering 64 KiB windows per entry
